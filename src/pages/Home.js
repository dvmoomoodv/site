        ...
        <div class="home">
            <div class="row">
                <div class="col-12 title">
                    <span class="d-block">안녕하세요. 이무현입니다. </span>
                    <span class="d-block">저는 프론트지향 풀스택 개발자입니다.  </span>
            ...
            <div class="row">
                ...
                <div class="col-12 title item">
                    Web Fullstack Developer
                </div>
                <div class="col-12 px-4 py-3">
                    <label>
                        <span class="tag big fit">Front end</span>
                    </label>         
                    <p>
                        <span class="tag">JQuery</span>
                        <span class="tag">AngularJS</span>
                        <span class="tag">Angular</span>
                        <span class="tag">Adobe Flex</span>
                        <span class="tag">DHTMLX</span>
                        <span class="tag">jQwidget</span> 
                    </p>
                    <label>
                        <span class="tag big">Back end</span>  
                    </label>
                    <p>
                    ...
                    <label>
                        <span class="tag big">Database</span>
                    </label>
                    <p>
                    ...
                    <label>
                        <span class="tag big">Etc</span>
                    </label>
                    <p>
                        <span class="tag">Git</span>
                        <span class="tag">SVN</span>
                        <span class="tag">CVS</span>
                ...
                <div class="col-12 px-4 py-3">
                    <p>
                        ...
                        <span class="tag">MaterialCss</span>
                    </p>
                </div>
                <div class="col-12 title item">
                    UI/UX Designer
